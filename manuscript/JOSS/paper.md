...
n.held-out <- n.trainest <- 5000
data.trainest <- sim.data(n.trainest, K, gamma, sigma, probability)
data.held-out <- sim.data(n.held-out, K, gamma, sigma, probability)
fit <- rjaf(data.trainest, data.held-out, y = "Y", id = "id", trt = "trt", 
