...
cases <- expand_grid(n.sim=n.sim, n.trainest=5000, ntree=1000, lambda1=c(0),
                     lambda2=0, reg=F, impute=F, epi=c(0.5), ntrt=K+1,
...
save(res, cases, file=paste0("/gpfs/home/ww857/Projects/Ladhania/DOF/results/unreg_multi_arm_cf_", K+1, "trt_ntrt", K+1,
